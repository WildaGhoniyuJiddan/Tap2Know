...
const PortfolioCardQuote = ({ card }) => {
  ...
  return (
    <div className="w-full h-full relative overflow-hidden rounded-2xl p-6 md:p-8 flex flex-col justify-center noise-overlay" style={{ backgroundColor: bgColor || '#324444', fontFamily: bodyFontFamily }}>
